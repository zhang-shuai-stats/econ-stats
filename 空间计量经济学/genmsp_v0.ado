program genmsp_v0, sortpreserve
...
* AUTOR: Maurizio Pisati
* "Exploratory spatial data analysis using Stata", in Presentation at German Stata User Group meeting, Berlin (, 2012)